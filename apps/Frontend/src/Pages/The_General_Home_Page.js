...
function Home() {
  ...
  const handleStartEcg = async () => {
    try {
      ...
      const statusRes = await axios.get(
        "http://localhost:5000/api/ecg/me/status",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
        ...
        <div className="row align-items-stretch justify-content-center text-center g-4">
          ...
          <div className="col-md-4">
            <div className="feature-card">
              ...
              <p className="cap_Card">
                Reliable Heart Disease Risk Assessment Using Advanced AI
              </p>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="feature-card">
              ...
              <p className="cap_Card">
                Detailed Risk Factor Analysis And Personalized Health
                Recommendations
              </p>
            </div>
          </div>
